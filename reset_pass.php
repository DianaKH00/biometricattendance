...
if (isset($_POST['reset_pass'])) {
	...
	$subject = 'Өз пароліңізді өшіріңіз!!';

	$message = '<p>Біз парольді қалпына келтіру туралы сұрау алдық. Құпия сөзді қалпына келтіру сілтемесі төменде. Егер сіз бұл сұрауды жібермеген болсаңыз, Сіз бұл электрондық поштаны елемеуіңіз мүмкін</p>';
	$message .= '<p>Құпия сөзді қалпына келтіруге арналған сілтеме: </br>';
